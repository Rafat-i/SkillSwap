...
export class AuthService {
  ...
  getUserByUsername(username: string): Observable<User> {
    return this.http.get<User>(`${this.BASE_URL}/users/${username}`, { headers: new HttpHeaders(this.getAuthHeaders()) });
  }
  ...
  getAuthHeaders() { return { Authorization: `Bearer ${this.getToken()}` }; }
}